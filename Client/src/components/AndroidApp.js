    ...
    <div id="android App" className="p-6">
      ...
      <div className="mt-4 flex justify-center">
        <div
          ...
          style={{
            backgroundImage: `url(${playstoreBg})`, // Use the imported image
        ...
        >
          <div className="flex justify-center w-full"> {/* This wrapper centers the button */}
            <a
              ...
              style={{
                border: "2px solid yellow", // Border for glass effect
                boxShadow: "0 4px 6px rgba(255, 255, 255, 0.2)", // Subtle glow effect
              }}
            >
              Download Now
            </a>
